...
const COUNTRY = [
  // \bus\b is safe here: countryOf only ever sees location strings ("Remote - US"),
  // never prose, and \b keeps it out of "australia"/"houston".
  [/united states|u\.s\.|\busa\b|\bus\b|, ca\b|, ny\b|, wa\b|, tx\b|, ma\b|california|new york|seattle|san francisco|bay area|mountain view|palo alto|sunnyvale|santa clara|san jose|san mateo|milpitas|bellevue|redmond|austin|boston|denver|chicago|washington/, "US"],
...
// JobPosting.applicantLocationRequirements wants a country NAME ("USA"), not an
// ISO code — remote roles are ineligible for Google's remote-job treatment
// without it. Covers exactly the codes countryOf can emit; "" stays "".
const COUNTRY_NAME = {
  US: "USA", GB: "United Kingdom", FR: "France", NL: "Netherlands", DE: "Germany",
  CH: "Switzerland", IE: "Ireland", ES: "Spain", SE: "Sweden", PL: "Poland",
  RS: "Serbia", CZ: "Czechia", AT: "Austria", IT: "Italy", PT: "Portugal",
  BE: "Belgium", JP: "Japan", KR: "South Korea", TW: "Taiwan", SG: "Singapore",
  IN: "India", CA: "Canada", AU: "Australia", TR: "Türkiye",
};
