...
export function regionOf(loc = "", remote = false) {
  ...
  if (/united states|u\.s\.|\busa\b|, ca|, ny|, wa|, tx|california|new york|seattle|san francisco|bay area|mountain view|palo alto|sunnyvale|santa clara|san jose|san mateo|milpitas|bellevue|redmond|austin|boston|denver|chicago|washington/.test(s)) return "US";
  if (/united kingdom|\buk\b|london|england|bristol|cambridge|oxford|manchester|edinburgh/.test(s)) return "UK";
  if (/germany|france|netherlands|amsterdam|paris|berlin|munich|zurich|zürich|switzerland|spain|madrid|barcelona|sweden|poland|ireland|dublin|serbia|belgrade|prague|czech|vienna|austria|milan|italy|lisbon|portugal|brussels|belgium|\beu\b|europe/.test(s)) return "EU";
